...
//				
				...
				driver.findElement(MobileBy.id("logonIdentifier")).sendKeys("DWeComm19@gmail.com");
				Thread.sleep(10000);
			    ...
			    Thread.sleep(10000);
			    driver.findElement(By.xpath("//android.view.View[@content-desc='Account Review']")).click();
			    ///need to set "Account review on top of the commented line
//				driver.findElement(MobileBy.xpath("//android.view.View[@content-desc='']")).click();
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc=\"HD Supply White Cap | Construction & Industrial - HD Supply White Cap\"]/android.view.View[1]/android.view.View[1]/android.view.View[3]/android.view.View/android.widget.EditText")).sendKeys("Nuts");
				Thread.sleep(10000);
				...
				driver.findElement(MobileBy.xpath("//*[@content-desc='ADD TO CART']")).click();
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.view.View[@content-desc='x']")).click();
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc=\"HD Supply White Cap | Construction & Industrial - HD Supply White Cap\"]/android.view.View[1]/android.view.View[1]/android.view.View[3]/android.view.View/android.widget.EditText")).sendKeys("262SCRS825");
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.widget.Button[@content-desc='Submit '']")).click();
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.widget.Button[@content-desc='ADD TO CART']")).click();
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.view.View[@content-desc=' 2']")).click();
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//*[@class='android.widget.EditText']")).click();
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//*[@class='android.widget.EditText']")).sendKeys("12345");
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//*[@class='android.widget.Button']")).click();
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[13]/android.view.View[4]/android.widget.EditText")).click();
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[13]/android.view.View[4]/android.widget.EditText")).sendKeys("FIRST2");
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[13]/android.view.View[5]/android.widget.EditText")).sendKeys("LAST2");
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[13]/android.view.View[6]/android.widget.EditText")).sendKeys("Hilltop Street");
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[13]/android.view.View[8]/android.widget.EditText")).sendKeys("Canton");
				Thread.sleep(10000);
				Select sc = new Select(driver.findElement(MobileBy.xpath("//android.widget.Spinner[@content-desc='Please Select...']")));
				sc.selectByVisibleText("Georgia");
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[13]/android.view.View[10]/android.widget.EditText")).sendKeys("30114");
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[13]/android.view.View[11]/android.widget.EditText")).sendKeys("7849302832");
				Thread.sleep(10000);
				...
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[14]/android.view.View[11]/android.widget.EditText")).sendKeys("Test11");
				Thread.sleep(10000);
				driver.findElement(MobileBy.xpath("//android.widget.Button[@content-desc='SAVE & CONTINUE']")).click();
				Thread.sleep(10000);
		        ...
		        Thread.sleep(10000);
		        driver.findElement(MobileBy.xpath("//android.webkit.WebView[@content-desc='Checkout - HD Supply White Cap']/android.view.View[2]/android.view.View[15]/android.view.View[3]/android.view.View[16]/android.view.View[1]/android.view.View/android.view.View/android.view.View/android.widget.EditText")).sendKeys("Test10");
		        Thread.sleep(10000);
			...
			public static void main(String[] args) throws MalformedURLException, InterruptedException {
				...
				AppiumE2E_012 obj = new AppiumE2E_012();
