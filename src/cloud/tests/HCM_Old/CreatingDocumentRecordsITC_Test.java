...
import cloud.components.HCM_Old.CreatingDocumentRecordsITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate;
import itc.framework.BaseTest;

public class CreatingDocumentRecordsITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate.run(1);
		CreatingDocumentRecordsITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
