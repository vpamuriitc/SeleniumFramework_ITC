...
public class ViewingandSubmittingaPurchaseOrderITC extends BaseTest{
	...
	private static void run() throws Exception{
	    ...
	    clickElement(By.linkText(Order_Number));//Purchase Order: 162685
	...
	public static void run(int iterations) throws Exception{
		...
		{
			iteration=i;
			popluateParams(ViewingandSubmittingaPurchaseOrderITC.class);
			run();
		}
	}
